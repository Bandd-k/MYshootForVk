...
public class OAuth2Module: AuthzModule {
    ...
    */
    ...
    public func extractCode(notification: NSNotification, completionHandler: (AnyObject?, NSError?) -> Void) {
    ...
    public func parametersFromQueryString(queryString: String?) -> [String: String] {
