...
public class VkConfig: Config {
    public init (clientId: String, clientSecret: String? = nil, scopes: [String],accountId: String? = nil,isOpenIDConnect: Bool = false){
        super.init(base: "https://oauth.vk.com/",
            authzEndpoint: "authorize" ,
            redirectURL: "vk\(clientId)://authorize",
            accessTokenEndpoint: "access_token",
            clientId: clientId,
            refreshTokenEndpoint: "access_token",
            revokeTokenEndpoint: "revoke",
            isOpenIDConnect: isOpenIDConnect,
            userInfoEndpoint: nil,
            clientSecret : clientSecret,// nil should be deleted
            scopes: scopes,
            accountId: accountId)
...
public class AccountManager {
    ...
    */
    ...
    public class func addVKAccount(config: VkConfig) -> VkOAuth2Module {
        return addAccount(config, moduleClass: VkOAuth2Module.self) as VkOAuth2Module
